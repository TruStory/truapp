...
export default class TrustorySelector extends Component {
  constructor (props) {
    super(props);
    this.state = {
  ...
  toggleItem = index => {
    const { options, returnObject, onPress , animateBack } = this.props;
  ...
  render () {
    ...
    const hitArea = { top: 10, bottom: 10, left: 10, right: 10 };
