...
const APP_ACCOUNT_CLAIMS_WITH_ARGUMENTS_QUERY = gql`
  query AppAccountClaimsWithArguments($id: String, $filter: Number, $first: Number, $after: String) {
    appAccountClaimsWithArguments(id: $id, first: $first, after: $after) {
      edges {
        node {
          ... FeedClaimFragment
...
export default APP_ACCOUNT_CLAIMS_WITH_ARGUMENTS_QUERY;
