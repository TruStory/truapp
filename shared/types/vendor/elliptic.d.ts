...
// This type definition file was copied from @types/elliptic.
// We've modified `SignOptions` to make `pers` optional, so that
// we can call the signing function with the appropriate parameters.
