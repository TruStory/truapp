...
// Updated for TruStory on 4/29/2019 for v3.0
...
declare module 'react-mentions' {
  ...
  export interface MentionsInputProps {
      ...
      onFocus?: (event: React.FocusEvent<HTMLInputElement> | React.FocusEvent<HTMLTextAreaElement>, clickedSuggestion: boolean) => void;
